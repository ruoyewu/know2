package com.wuruoye.know.util.base.media;
...
import com.wuruoye.know.util.base.permission.IWPermission;
import com.wuruoye.know.util.base.permission.PermissionConfig;
 ...
 * {@link } 调用系统内部获取照片 Activity 并返回结果
 */

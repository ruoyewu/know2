...
/**
 * Created at 2019-04-21 18:59 by wuruoye
 * Description:
 */
class ReviewStrategySetAdapter :
    ListAdapter<ReviewStrategy, ReviewStrategySetAdapter.ViewHolder>(Callback()){
    ...
    private var mSelectSet: HashSet<ReviewStrategy> = HashSet()
    ...
    fun getSelectSet(): HashSet<ReviewStrategy> {
        return mSelectSet
    }
    ...
    interface OnClickListener {
        ...
        fun onDelClick(item: ReviewStrategy)
    }
}